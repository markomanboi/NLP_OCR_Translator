...
public class JustTranslate extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_just_translate);
        ...
        btnTranslate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (detectedLanguage.equals("null") || selectedLanguage.equals("Select") || detectedLanguage.equals(selectedLanguage)){
                    Toast.makeText(JustTranslate.this, "Please try again!", Toast.LENGTH_SHORT).show();
                }else {
            ...
            public void onInit(int i) {
                if (i == TextToSpeech.SUCCESS){
                    if (detectedLanguage.equals("German")) {
                        ...
                        Toast.makeText(JustTranslate.this, "TTS Language not supported!", Toast.LENGTH_SHORT).show();
                    }
        ...
        tts1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (txtLanguage.getText().toString().isEmpty()){
                    Toast.makeText(JustTranslate.this, "No text to process!", Toast.LENGTH_SHORT).show();
                }
                else {
                    identifyLanguage(txtLanguage.getText().toString());
        ...
        tts2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (txtResult.getText().toString().isEmpty() || selectedLanguage.equals("Select")){
                    Toast.makeText(JustTranslate.this, "No text to process or selected language error!", Toast.LENGTH_SHORT).show();
                }else {
                    identifyLanguage(txtLanguage.getText().toString());
                    ...
                    .addOnFailureListener(
                            new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(JustTranslate.this, "Internal error", Toast.LENGTH_SHORT).show();
                                }
                            });
        }
    }
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<String>() {
                            ...
                            public void onSuccess(@NonNull String translatedText) {
                                ...
                                Toast.makeText(JustTranslate.this,"Text Translated",Toast.LENGTH_SHORT).show();
                                sentimentAnalysis();
                            }
                        })
                .addOnFailureListener(
                        new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(JustTranslate.this,"Model is still downloading please try again!",Toast.LENGTH_SHORT).show();
                            }
                        });
    }
